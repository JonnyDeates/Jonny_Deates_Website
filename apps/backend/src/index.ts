...
const createServer = async () => {
    ...
    app.use("/robots.txt", async function (req, res, next) {
        express.static("build/robots.txt")(req, res, next)
    });
    ...
    app.get("/about", (req, res) => sendIndexHtml(req, res));
    app.get("/projects", (req, res) => sendIndexHtml(req, res));
