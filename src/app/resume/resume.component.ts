...
export class ResumeComponent implements OnInit {
  ...
  constructor(private router: JRouter) {
    ...
    this.database.ref('resume/scripts').once('value').then((snapshot) => {
      for (let key in snapshot.val()) {
        this.languages.splice(0, 0, {
          title: snapshot.val()[key].title,
          paragraphs: snapshot.val()[key].paragraphs,
    ...
    this.languages = [{
      title: 'JavaScript', description: [
        `I developed independent portfolios and small simple applications using pure Javascript. I have made small inbrowser games as well using javascript, and htmls canvas.`,
      ...
      title: 'React', description: [
        'I use React in my back-end applications for my clients. I do it this way, because most back-end systems only need to edit a database directly, a database that their website is using. Using React allows for rapid development of these back-end applications.',
