    ...
    render() {
        return (
            <div className="projectList">
                ...
                <p className="project-descr">{this.state.description}<span onClick={()=> window.open('https://twitter.com/jonnydeates')}>twitter.</span></p>
                {this.state.projects.map((obj, i) => <Project key={'project' + i} title={obj.title} subTitle={obj.subTitle}
